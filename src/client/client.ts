...
const cubRotationFolder = cubeFolder.addFolder("rotation")
cubRotationFolder.add(cube.rotation, "x", 0, Math.PI * 2, 0.01)
cubRotationFolder.add(cube.rotation, "y", 0, Math.PI * 2, 0.01)
cubRotationFolder.add(cube.rotation, "z", 0, Math.PI * 2, 0.01)
...
sphereFolder.add(sphereData, 'thetaStart', 0, Math.PI * 2).onChange(regenerateSphereGeometry)
sphereFolder.add(sphereData, 'thetaLength', 0, Math.PI * 2).onChange(regenerateSphereGeometry)
